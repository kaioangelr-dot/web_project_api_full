...
export default function Header({ isLoggedIn, setIsLoggedIn, email, isLight, setTheme }) {
  ...
  return (
    <header className={`header page__section ${showoptions && "header__options"}`}>
      <img alt="Logotipo Around The U.S." className={`logo header__logo `} src={isLight ? logoBlack : logo} />
      {isLoggedIn && (
        <button
