...
export default function Header({ isLoggedIn, setIsLoggedIn, email, light }) {
  ...
  return (
    <header className={`header page__section ${showoptions && "header__options"}`}>
      <img alt="Logotipo Around The U.S." className={`logo header__logo `} src={light ? logoBlack : logo} />
      {isLoggedIn && (
        <button
